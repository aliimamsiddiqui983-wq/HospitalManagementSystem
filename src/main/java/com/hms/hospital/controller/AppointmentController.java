...
public class AppointmentController {
    ...
    public List<?> doctorEvents(Principal principal) {
        ...
        return toCalendarEvents(appointmentRepo.findByDoctorIdOrderByStartTimeAsc(doctor.getId()));
    }
    ...
    public List<?> getEvents(Principal principal) {
        ...
        return toCalendarEvents(list);
    }

    private List<?> toCalendarEvents(List<Appointment> appointments) {
        return appointments.stream().map(a -> Map.of(
                "id", a.getId(),
                "title", a.getTitle(),
